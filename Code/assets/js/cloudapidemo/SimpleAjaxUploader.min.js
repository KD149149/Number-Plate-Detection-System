/** Simple Ajax Uploader v2.5.0 Copyright 2012-2015 LPology, LLC  MIT license https://github.com/LPology/Simple-Ajax-Uploader */ ! function(e, t) {
    ...
    var t, s = e.ss || {},
        ...
        d = -1 !== navigator.userAgent.indexOf("MSIE 7"),
    ...
    return s.indexOf = h.indexOf ? function(e, t) {
        ...
        "use strict";
        return 1 !== e.nodeType || e == document.body ? (e = null, !0) : e.offsetWidth > 0 || e.offsetHeight > 0 || "none" != s.getStyle(e, "display").toLowerCase() ? s.isVisible(e.parentNode) : (e = null, !1)
        ...
        submit: function(e, t) {
            "use strict";
            return !t && this._queue.length < 1 ? void this._opts.onBlankSubmit.call(this) : void(this._disabled || this._active >= this._opts.maxUploads || this._queue.length < 1 || this._checkFile(this._queue[0]) && !1 !== this._opts.onSubmit.call(this, this._queue[0].name, this._queue[0].ext, this._queue[0].btn, this._queue[0].size) && (this._active++, (this._opts.multiple === !1 || this._opts.queue === !1 && this._active >= this._opts.maxUploads) && this.disable(!0), this._initUpload(this._queue[0])))
        }
    }, s.IframeUpload = {
        _detachEvents: {},
        _detach: function(e) {
        ...
        _uploadXhr: function(e, t, n, i, o, r, a, u, l, d) {
            ...
            o && (o.innerHTML = e.size + "K"), u && (u.innerHTML = "0%"), r && (r.style.width = "0%"), c = function(t, n) {
                ...
                try {
                    if (c && (n || 4 === _.readyState))
                        if (c = void 0, _.onreadystatechange = function() {}, n) 4 !== _.readyState && _.abort(), f.onAbort.call(h, e.name, e.btn, e.size), h._last(o, a, u, l, d);
                        else {
            ...
            if (s.addEvent(_.upload, "progress", function(e) {
                ...
                var g = new FormData;
                for (var v in n) n.hasOwnProperty(v) && g.append(v, n[v]);
                g.append(f.name, e.file), this.log("Commencing upload using multipart form"), _.send(g)
        ...
        addDropZone: function(e) {
            ...
            s.addStyles(e, {
                ...
                return e.stopPropagation(), e.preventDefault(), t._dragFileCheck(e) ? (s.addClass(this, t._opts.dragClass), !1) : !1
                ...
                e.stopPropagation(), e.preventDefault(), s.removeClass(this, t._opts.dragClass), t._dragFileCheck(e) && !1 !== t._addFiles(e.dataTransfer.files) && t._cycleQueue()
            }
        }
        ...
        _last: function(e, t, n, i, o) {
            "use strict";
            if (e && (e.innerHTML = ""), n && (n.innerHTML = ""), i && o && s.remove(i), t && s.remove(t), this._active--, e = t = n = i = o = null, this._disabled && this.enable(!0), this._destroy && 0 === this._queue.length && 0 === this._active.length)
                for (var r in this) this.hasOwnProperty(r) && delete this[r];
            else this._cycleQueue()
        },
